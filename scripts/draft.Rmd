...
#Random Forest
```{r}
train_x <- as.data.frame(training_projected)
test_x <- as.data.frame(test_projected)
train_y <- as.data.frame(train_labels)
test_y <- as.data.frame(test_labels)
```
...
training <- merge.data.frame(train_x, train_y) 
