...
### Step 1: Fit a RandomForest model on the PCA training data

```{r}
set.seed(14531)
rf_model <- randomForest(bg_group ~ ., data = reduced_training, ntree = 500, mtry = 5, importance = TRUE)
...
```{r}
#Evaluate the Model
predictions <- predict(rf_model, newdata = reduced_testing)
