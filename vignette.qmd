...
# Optional: Calculate additional metrics like precision, recall, and F1-score for each class
library(caret)
confusionMatrix(as.factor(logreg_test_predictions), as.factor(reduced_testing$bg_group))
