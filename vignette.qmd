...
train_features_sparse <- train_features %>% 
  as("sparseMatrix")
...
# Project
test_projected <- reproject_fn(test_features, train_svd)
```
...
combined_data <- merge(hh_bgDensity, data, by = 'hhid')
...
# Split the dataset
partitions <- initial_split(data, prop = 0.8)
